    ...
    <div className='featured'>
      <div className="featuredItem">
        ...
        <div className="featuredItemText">
          <h1 className="primaryHeader">New Delhi</h1>
          <h3 className='secondaryHeader'>Red Fort</h3>
        </div>
      </div>
      <div className="featuredItem">
        ...
        <div className="featuredItemText">
          ...
          <h3 className='secondaryHeader'>Juhu</h3>
        </div>
      </div>
      <div className="featuredItem">
        ...
        <div className="featuredItemText">
          ...
          <h3 className='secondaryHeader'>Jagganath Mandir</h3>
        </div>
      </div>
    </div>
  )
